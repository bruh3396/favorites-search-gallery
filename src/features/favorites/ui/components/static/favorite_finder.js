class FavoriteFinder {
  ...
  createElements() {
    ...
    this.container.id = "favorite-finder";

    this.findButton = document.createElement("button");
    this.findButton.id = "favorite-finder-button";
    ...
    this.findInAllButton.id = "favorite-finder-in-all-button";
    ...
    this.input.id = "favorite-finder-input";
