...
export const searchFavorites = (query: string): Favorite[] => FavoritesSearcher.search(FavoritesCollection.getAll(), query);
export const reSearchFavorites = (): Favorite[] => FavoritesSearcher.reSearch(FavoritesCollection.getAll());
export const invertSearchResults = (): Favorite[] => FavoritesSearcher.invertResults(FavoritesCollection.getAll());
export const repaginateCurrentResults = (): Favorite[] => FavoritesPaginator.paginate(FavoritesSearcher.getCurrentSearchResults());

export { getAll as getAllFavorites, get as getFavorite } from "@/features/favorites/model/collection";
