...
const FavoritesSearchEngine = new SearchEngine<Favorite>(favorite => favorite.tags);
...
export const index = (favorites: Favorite[]): void => FavoritesSearchEngine.index(favorites);
