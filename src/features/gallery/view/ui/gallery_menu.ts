...
import { GalleryMenuButton } from "../../types/gallery_types";
  ...
  { id: "fullscreen-gallery", icon: Icons.FULLSCREEN_ENTER, action: "fullscreen", enabled: true, handler: "galleryMenu", hint: "Toggle Fullscreen (F)", color: "#0075FF" },
  { id: "open-in-new-gallery", icon: Icons.OPEN_IN_NEW, action: "openPost", enabled: true, handler: "galleryController", hint: "Open Post (Middle-Click, G)", color: "lightgreen" },
  { id: "open-image-gallery", icon: Icons.IMAGE, action: "openOriginal", enabled: true, handler: "galleryController", hint: "Open Original (Ctrl + Left-Click, Q)", color: "magenta" },
  { id: "download-gallery", icon: Icons.DOWNLOAD, action: "download", enabled: true, handler: "galleryController", hint: "Download", color: "lightskyblue" },
  { id: "add-favorite-gallery", icon: Icons.HEART_PLUS, action: "addFavorite", enabled: true, handler: "galleryController", hint: "Add Favorite (E)", color: "hotpink" },
  { id: "remove-favorite-gallery", icon: Icons.HEART_MINUS, action: "removeFavorite", enabled: false, handler: "galleryController", hint: "Remove Favorite (X)", color: "red" },
 ...
 */
function constructor(galleryContainer) {
 ...
 * @returns {HTMLElement}
 */
function createContainer(galleryContainer) {
