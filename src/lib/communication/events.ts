...
import { EventEmitter } from "../core/events/event_emitter";
...
const favorites = {
  ...
  newFavoritesFoundOnReload: new EventEmitter<Favorite[]>(true),
  ...
  layoutChanged: new EventEmitter<LayoutMode>(true),
...
const document1 = {
  ...
  mouseover: new EventEmitter<EnhancedMouseEvent>(true),
  ...
  keydown: new EventEmitter<EnhancedKeyboardEvent>(true),
  keyup: new EventEmitter<EnhancedKeyboardEvent>(true),
  wheel: new EventEmitter<EnhancedWheelEvent>(true),
