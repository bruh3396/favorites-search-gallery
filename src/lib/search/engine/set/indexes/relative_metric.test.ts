...
function comparison(metric: SearchableMetric, operator: MetricSearchComparison["operator"], rightHandMetric: SearchableMetric): MetricSearchComparison {
  return { metric, operator, value: 0, rightHandMetric, isRelative: true, isTautological: false } as MetricSearchComparison;
}
