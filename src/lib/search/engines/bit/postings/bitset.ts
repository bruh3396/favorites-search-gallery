export type PositionArray = Uint8Array | Uint16Array | Uint32Array;
...
export class BitSet {
  ...
  public andPositionsInPlace(positions: PositionArray): boolean {
  ...
  public positions(): number[] {
    const result = new Array<number>(this.cardinality());
    let next = 0;
