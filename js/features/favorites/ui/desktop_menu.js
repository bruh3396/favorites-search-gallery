class FavoritesDesktopMenu {
  ...
  template = {
    ...
    "checkboxOption": [
      ...
      {id: "show-download-buttons", parentId: "favorite-options", textContent: "Download Buttons", title: "Toggle download buttons", enabled: true, preference: Preferences.showDownloadButtons, hotkey: "", invokeActionOnCreation: true, savePreference: true, event: Events.favorites.downloadButtonsToggled},
