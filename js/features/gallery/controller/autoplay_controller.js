class AutoplayController {
  ...
  initializeTimers() {
    this.imageViewTimer = new Timer(AutoplayController.settings.imageViewDuration);
    this.menuVisibilityTimer = new Timer(AutoplayController.settings.menuVisibilityDuration);
    this.videoViewTimer = new Timer(AutoplayController.settings.minimumVideoDuration);

    this.imageViewTimer.onTimerEnd = () => { };
    this.menuVisibilityTimer.onTimerEnd = () => {
      this.hideMenu();
      setTimeout(() => {
