class GalleryMenu {
  ...
  static buttons = [
    ...
    {id: "open-image-gallery", icon: SVGIcons.image, action: "openOriginal", enabled: true, handler: "galleryController", hint: "Open Original (Ctrl + Left-Click, Q)", color: "magenta"},
    {id: "download-gallery", icon: SVGIcons.download, action: "download", enabled: true, handler: "galleryController", hint: "Download", color: "lightskyblue"},
