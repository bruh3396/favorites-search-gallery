class FavoritesMenuDesktopUI {
  ...
  static template = {
    ...
    "checkboxOption": [
      ...
      {id: "infinite-scroll", parentId: "favorite-options", textContent: "Infinite Scroll", title: "Use infinite waterfall scroll instead of pages", action: "toggleInfiniteScroll", enabled: true, preference: Preferences.infiniteScroll, hotkey: "", invokeActionOnCreation: true, savePreference: true},
